...
C {lab_pin.sym} 260 40 0 0 {name=p1 sig_type=std_logic lab=VSS}
...
C {iopin.sym} -160 -330 2 0 {name=p6 lab=VSS}
...
C {lab_pin.sym} -270 40 0 0 {name=p4 sig_type=std_logic lab=VSS}
